...
#define SERVO1_PIN OSTRICH_TRIGORILLA_S1
#define SERVO2_PIN OSTRICH_TRIGORILLA_S2
...
#define HEATER_1_PIN OSTRICH_TRIGORILLA_HEATER1
...
// Laser Control
//
#define SPINDLE_LASER_ENABLE_PIN OSTRICH_TRIGORILLA_HOTBED
#define SPINDLE_LASER_PWM_PIN OSTRICH_TRIGORILLA_S3
